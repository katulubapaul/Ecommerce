...
from .views import Login_View, Register_View, Logout_View,home, switch, userprofile, product_details, userprofilechange, products, Seller_View, dashboard, Buyer_view
